...
use Jul6Art\AuthBundle\Tests\Fixtures\TestKernel;
...
abstract class AbstractFunctionalTestCase extends TestCase
{
     ...
     */
    final protected function boot(string $environment = 'test', array $authConfig = []): ContainerInterface
    {
        $uniqueId = substr(md5(serialize($authConfig)), 0, 12);

        $this->kernel = new TestKernel($environment, $authConfig, $uniqueId);
        $this->kernel->boot();
